      ...
      <Tailwind>
        <div>
          ...
          <div className="text-right">
            ...
            <p className="mb-1 p-0">1600 Pennsylvania Avenue NW,</p>
            <p className="mb-1 p-0">Washington,</p>
            <p className="mb-1 p-0">DC 20500,</p>
            <p className="mb-1 p-0">United States of America</p>
          </div>
          ...
          <div>
            ...
            <p className="mb-1 p-0">Titouan LAUNAY</p>
            <p className="mb-1 p-0">72 Faxcol Dr Gotahm City,</p>
            <p className="mb-1 p-0">NJ 12345,</p>
            <p className="mb-1 p-0">United States of America</p>
          </div>
          ...
          <table className="my-12 w-full">
            <tr className="border-b border-gray-300">
              ...
              <th className="py-2 text-left font-bold">Unit Price</th>
              <th className="py-2 text-left font-bold">Quantity</th>
            ...
            <tr className="border-b border-gray-300">
              ...
              <th className="py-2 text-left font-bold">Total</th>
              <th className="py-2 text-left font-bold"></th>
              <th className="py-2 text-left font-bold"></th>
              <th className="py-2 text-left font-bold">$100</th>
            </tr>
          </table>

          <div className="rounded-md border-blue-300 bg-blue-100 p-3 text-sm text-blue-800">
          ...
          <PageBottom>
            <div className="my-4 h-px bg-gray-300" />
            <div className="text-sm text-gray-400">Invoice #1234</div>
          </PageBottom>
        </div>
      </Tailwind>
    </div>
