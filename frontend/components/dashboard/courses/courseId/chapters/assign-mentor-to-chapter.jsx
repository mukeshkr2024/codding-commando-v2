...
export function AssignMentorToChapter({
  initialData,
  courseId,
  onUpdateSuccess,
  moduleId,
  ...
  const fetchMentors = async () => {
    try {
      ...
      const { data } = await apiClient.get(
        `/courses/${courseId}/assigned-instructors`,
        config,
      );
  ...
  const handleAssignMentor = async () => {
    try {
      ...
      await apiClient.post(
        `/courses/${courseId}/modules/${moduleId}/chapters/${chapterId}/assign-mentor`,
        dataToSend,
        config,
      );
  ...
  const handleUnAssignMentor = async (value) => {
    try {
      ...
      await apiClient.post(
        `/courses/${courseId}/modules/${moduleId}/chapters/${chapterId}/unassign-mentor`,
        dataToSend,
        config,
      );
